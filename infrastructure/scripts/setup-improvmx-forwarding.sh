...
echo ""
echo "3. Enter your domain: fundrbolt.app"
echo ""
echo "4. Add forwarding rules:"
echo "   admin@fundrbolt.app    → jeanes.dev@gmail.com"
echo "   Legal@fundrbolt.app    → jeanes.dev@gmail.com"
echo "   Privacy@fundrbolt.app  → jeanes.dev@gmail.com"
echo "   DPO@fundrbolt.app      → jeanes.dev@gmail.com"
echo ""
echo "5. Optional: Add catch-all (*@fundrbolt.app → jeanes.dev@gmail.com)"
echo ""
...
echo "   After that, test by sending email to admin@fundrbolt.app"
