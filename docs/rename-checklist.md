...
Source: Derived from research.md plus fresh grep counts of "Augeo" across the monorepo.

## Current Augeo Reference Counts (pre-rename)
- Code: 2,867 (backend 2,715; frontend/augeo-admin 48; frontend/donor-pwa 62; frontend/landing-site 39; frontend/shared 3)
...
```
grep -R -i "augeo" <path> --exclude-dir=.git --exclude-dir=node_modules --exclude-dir=.venv \
...
## Hotspots
- backend/: High density of Augeo strings in config, API responses, middleware, tests.
- infrastructure/: Resource names, parameters, and scripts carry Augeo identifiers.
